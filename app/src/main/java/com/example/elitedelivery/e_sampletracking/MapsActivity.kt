...
class MapsActivity : AppCompatActivity(), OnMapReadyCallback, DirectionUtil.DirectionCallBack,
    ...
    lateinit var end_update:Button
...
//        markerOptionsOrigin.rotation(SphericalUtil.computeHeading(origin, waypoint1).toFloat())
        for (data in polyLineDetails){
            data.position?.let {
                ...
                markerOptionswayPoint.icon(BitmapDescriptorFactory.fromResource(R.drawable.map_marker));
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        end_update = findViewById(R.id.end_update)
    ...
    override fun onMapReady(googleMap: GoogleMap) {
        ...
        markerOptionsOrigin.icon(BitmapDescriptorFactory.fromBitmap(getIcon(R.drawable.map_marker)));
        ...
        markerOptionsDestination.icon(BitmapDescriptorFactory.fromResource(R.drawable.map_marker));
        ...
        try {
            ...
            location?.let {
                ...
                if (movingCabMarker == null){
                    markerOptionsOrigin
                        .icon(BitmapDescriptorFactory.fromBitmap(getIcon(R.drawable.motorbike)))
                        .anchor(0.5f, 0.5f)
